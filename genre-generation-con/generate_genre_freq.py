...
def main():
	...
	parser.add_argument('--model_path', type=str,
	                    default='/data/anussank/shavak/GAN/genre_argmax_3/-42',
	...
	with open("/home/anussank/shavak/genre-generation-argmax/arg_3/freq_out_42.txt", 'w+') as f:
		for genres in caption_image_dic.keys():
			...
			for c in wordcount.most_common(20):
				f.write(c[0].encode('ascii') + ' ' + str(c[1]) + '\n')
